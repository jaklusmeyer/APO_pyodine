...
def recover_obs_results(filename):
    result = pyodine.fitters.load_results(filename)
    ...
    if temp_path:
        ...
        temp = None
    iod = utilities.load_pyodine.IodineAtlas(1)
    ...
    if temp:
        ...
        obs_chunks = pyodine.chunks.user_defined(obs, width=abs(res_chunks['lastpix'][1]-res_chunks['firstpix'][1])+1,
    ...
    pars = model.guess_params(obs_chunks[0])
