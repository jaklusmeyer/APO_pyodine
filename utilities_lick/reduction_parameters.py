...
class Parameters_Lick:
    ...
    def __init__(self):
        ...
        # General information:
        self.input_directory = '../data/data_raw/hip102488_iodspec'    # Directory to work on
        ...
        self.output_directory = '../data/data_ext/hip102488_iodspec'   # Results directory
        ...
        self.max_pix_shift_disp = 5       # Max. pixel shift of lines in disp. direction
