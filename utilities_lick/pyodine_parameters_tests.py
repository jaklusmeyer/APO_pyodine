...
class Parameters_Lick:
    ...
    def __init__(self):
        ...
        self.order_range = (None,None)      # Order range (min,max) of template to use in observation modeling
...
class Template_Parameters_Lick:
    ...
    def __init__(self):
        ...
        self.chunk_algorithm = 'edge_to_edge' # One of 'simple' or 'edge_to_edge'
        ...
        self.deconvolution_pars = {
                'osample_temp': 10.0,             # Oversampling of template
