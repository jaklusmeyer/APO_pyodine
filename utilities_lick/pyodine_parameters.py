...
class Parameters_Lick:
    ...
    def __init__(self):
        ...
        self.bad_pixel_cutoff = 0.24        # Cutoff parameter for the bad pixel mask
        ...
        self.velgues_order_range = (32,37)
...
def constrain_parameters(lmfit_params, run_id, run_results):
    """
