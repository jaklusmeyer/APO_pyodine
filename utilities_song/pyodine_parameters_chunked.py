...
class Parameters:
    ...
    def constrain_parameters(self, lmfit_params, run_id, run_results, fitter):
        ...
        Args:
            lmfit_params (list): A list of :class:'lmfit.Parameters' objects
                for each chunk.
            run_id (int): The current run_id, to allow different definitions
                from run to run.
            run_results (dict): Dictionary with important observation info and
                results from previous modelling runs.
            fitter (:class:'LmfitWrapper'): The fitter used in the modelling.
        
        Return:
            list: The updated list of :class:'lmfit.Parameters' objects.
        """
