...
class Parameters_Lick:
    ...
    def __init__(self):
        ...
        self.chunk_width = 90               # Width of chunks in pixels in observation modeling
        self.chunk_padding = 4              # Padding (left and right) of the chunks in pixels
        ...
        self.model_runs = {
                ...
                1:
                {# First define the LSF
                 'lsf_model': models.lsf.MultiGaussian,
                 # Fitting keywords
...
class Template_Parameters_Lick:
    ...
    def __init__(self):
        ...
        self.temp_order_range = (15,31)     # Order range (min,max) to use in template creation
        # Jansson deconvolution LSF smoothing?
        self.jansson_lsf_smoothing = {
                'do_smoothing': True,           # If False, do no LSF smoothing
                'smooth_lsf_run': 1,            # If not given, use last run
                'smooth_pixels': 160,           # Pixels (in dispersion direction) to smooth over
                'smooth_orders': 3,             # Orders (in cross-disp direction) to smooth over
                'order_separation': 15,         # Avg. pixels between orders in raw spectrum
        ...
        self.jansson_run_model = 2              # Model (LSF, wave, cont) from this run used in deconvolution
